...
from .controllers.business_controller import SearchBusiness, SummarizeBusiness, BusinessCategories, BusinessInformation
...
def initialize_routes(api):
    ...
    api.add_resource(BusinessInformation, '/business/search/information')
